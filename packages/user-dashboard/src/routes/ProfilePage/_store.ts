...
import { putUserAction as UserStatusPutUserAction, UserStatuseUserProps } from "src/stores/UserStatuseStore";
...
const putUserAction = action(
  profileStore,
  "putUserAction",
  async (store, data: UserStatuseUserProps): Promise<void> => {
