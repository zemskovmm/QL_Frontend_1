...
export const NotificationItem: FC<PropsType> = ({ data: { id, message, group }, onRemove }) => {
  const classes = ["inline-flex p-2 rounded border max-w-md", NotificationColors[group]].join(" ");
