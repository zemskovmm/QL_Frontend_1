...
export const putUserAction = action(userStatuseStore,"putUserAction", async (store, data: UserStatuseUserProps): Promise<boolean> => {
...
const heartbeatAction = action(userStatuseStore,"heartbeatAction", async (store): Promise<boolean> => {
...
export const loginAction = action(userStatuseStore,"loginAction", async (store, data: UserStatuseLoginProps): Promise<boolean> => {
...
export const registerAction = action(userStatuseStore,"registerAction", async (store,data: UserStatuseRegisterProps): Promise<boolean> => {
...
const logoutAction = action(userStatuseStore,"logoutAction", async (store): Promise<boolean> => {
